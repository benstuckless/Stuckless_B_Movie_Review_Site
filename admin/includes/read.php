<?php
	...
	function getComments(){
		include('connect.php');
		$queryComments = "SELECT tbl_comments.comment, tbl_movies.movies_id, tbl_comments.movies_id
FROM tbl_comments
INNER JOIN tbl_movies WHERE tbl_comments.movies_id=tbl_movies.movies_id";
